...
$(BUILD_DIR)/durango.lib: $(BUILD_DIR)/crt0.o $(BUILD_DIR)/geometrics.o $(BUILD_DIR)/glyph.o $(BUILD_DIR)/common.o  $(BUILD_DIR)/system.o $(BUILD_DIR)/sprites.o $(BUILD_DIR)/psv.o $(BUILD_DIR)/qgraph.o $(BUILD_DIR)/music.o $(BUILD_DIR)
	cp /usr/share/cc65/lib/supervision.lib $(BUILD_DIR)/durango.lib && ar65 a $(BUILD_DIR)/durango.lib $(BUILD_DIR)/common.o $(BUILD_DIR)/sprites.o $(BUILD_DIR)/psv.o $(BUILD_DIR)/system.o $(BUILD_DIR)/geometrics.o $(BUILD_DIR)/glyph.o $(BUILD_DIR)/music.o $(BUILD_DIR)/crt0.o
